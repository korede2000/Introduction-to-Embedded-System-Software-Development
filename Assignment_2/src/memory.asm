	...
	.text
.Ltext0:
	.file 0 "/home/akorede/Molade_Coursera/Assignment_2/src" "memory.c"
	.globl	set_value
...
.LASF7:
	.string	"value"
.LASF10:
	.string	"GNU C99 11.2.0 -mtune=generic -march=x86-64 -g -O0 -std=c99 -fasynchronous-unwind-tables -fstack-protector-strong -fstack-clash-protection -fcf-protection"
.LASF6:
	.string	"set_all"
.LASF8:
	.string	"index"
...
.LASF1:
	.string	"/home/akorede/Molade_Coursera/Assignment_2/src"
.LASF0:
	.string	"memory.c"
